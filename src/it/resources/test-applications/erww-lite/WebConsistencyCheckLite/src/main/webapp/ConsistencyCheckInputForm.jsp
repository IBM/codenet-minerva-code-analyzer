...
<%@page
	...
	import="consistency.check.lite.ForceIncrementServlet"%>
<html>
<head>
<title>ConsistencyCheckInputForm</title>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
</head>
<body bgcolor="#F8F7CD">
<form name="myForm" method="POST" action="ForceIncrementServlet">
<h2 align="center"><font color="navy">ERWW Consistency Checks using JPA 2.x</font></h2>
<h3 align="center"><font color="navy"><i>Pessimistic_Force_Increment or Optimistic_Force_Increment</i></font></h3>
...
<h4><font face="Arial" color="#804000">Lock Mode: </font><select name="lockMode"
	style="font-style: normal; background-color: white; border-color: gray; font-weight: bold; margin: auto; padding: 6px; border-style: groove; border-width: thick">
	<option selected>Pessimistic_Force_Increment</option>
	<option>Optimistic_Force_Increment</option>
</select></h4>
<h4><font face="Arial" color="#804000">Maximum Number of Retries (only applicable to Optimistic_Force_Increment):</font>
<input type="text" name="numberOfRetries" size="5" value="1"></h4>
...
<p align="center">
	...
	<font face="Arial" color="#804000" size="4">Consistency Check 13</font></label></p>	 
<hr	style="border-color: gray; border-style: outset; border-width: thick">
</form>
</body>
</html>