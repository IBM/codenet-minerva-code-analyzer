...
public class CustomerTablePartitionMapper implements PartitionMapper {
	 ...
	 * Default constructor. 
	 */
	public CustomerTablePartitionMapper() {
	...
	public PartitionPlan mapPartitions() {
		...
		debugOut("Customer table mapper, step name is: " + stepCtx.getStepName());
		...
		if (numWarehouses == 1) {
			...
			System.out.println("CustomerTablePartitionMapper is making 10 district partitions for 1 warehouse");
			...
			System.out.println("CustomerTablePartitionMapper is making " + numWarehouses + " partitions, one per warehouse");
