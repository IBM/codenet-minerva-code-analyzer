...
public class OrderAndOrderlineTablePartitionMapper implements PartitionMapper {
	 ...
	 * Default constructor. 
	 */
	public OrderAndOrderlineTablePartitionMapper() {
	...
	public PartitionPlan mapPartitions() {
		...
		debugOut("Order and Orderline partition mapper step name is: " + stepCtx.getStepName());
		...
		if (numWarehouses == 1) {
			...
			System.out.println("OrderAndOrderlineParitionMapper is making 10 district partitions for 1 warehouse");
			...
			System.out.println("OrderAndOrderlinePartitionMapper is making " + numWarehouses + " partitions, one per warehouse");
