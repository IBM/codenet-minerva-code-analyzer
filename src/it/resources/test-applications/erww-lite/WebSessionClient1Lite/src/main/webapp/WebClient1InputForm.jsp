...
<html>
<head>
<title>WebClient1InputForm</title>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">

<title>Web Client 1 - Session Sharing/URL Rewriting Input Form</title>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<meta name="GENERATOR"
...
<H1>Web Client 1 - Cookie/URL Rewriting with Session Sharing Input Form </H1>

<!--Form-->
<FORM name="myForm" method="POST" action="WebClient1Servlet">
	<INPUT TYPE="hidden" NAME="command" VALUE="WebClient1ResultsForm">
