...
<html>
<head>
<title>WebClient1ResultsForm</title>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<%@ taglib prefix="callSessionTag" uri="http://WebSessionClient1Lite/CallSessionTag.tld"%>
<TITLE>Client1 - Session Test Results page</TITLE>
...
<!--Banner-->
		<callSessionTag:session>
 				<jsp:attribute name="jspFragment1"> 
					<H1>Client1 - Session Test Results page</H1><BR>
					<H2>${message}</H2>
					<H3>===================================================================</H3>
