...
<%@ page import="orderstatus.lite.OrderStatusOutput" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
<title>Order Status Lite Results</title>
<!--styles-->
<style>
<!--
BODY
...
<body>
<h1>Order Status Lite Results</h1>
<f:view>
...
%>
        ...
        <tr><td><%= "Supply Warehouse ID: " + output.getOutOrderLines()[i].getOutOlSupplyWarehouseId()%></td></tr>
        <tr><td><%= "Item ID: " + output.getOutOrderLines()[i].getOutOlItemId()%></td></tr>
        <tr><td><%= "Item Quantity: " + output.getOutOrderLines()[i].getOutOlQuantity()%></td></tr>
        <tr><td><%= "Item Amount: " + output.getOutOrderLines()[i].getOutOlAmount()%></td></tr>
        <tr><td><%= "Item Delivery Date: " + output.getOutOrderLines()[i].getOutOlDeliveryDate()%></td></tr>
        <tr><td><%= "_____________________________"%></td></tr>
<%       
    }
}
