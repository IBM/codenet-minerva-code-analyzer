...
<head>
	...
	<title>WebMonitorTransactionsLite_WebSocket1.0</title>
...
function openWebSocket() {
	wsocket = new WebSocket("ws://" + document.location.host + getContextPath() + "/monitor");
...
<body class="claro">
	<H1 align="center">Monitor Transactions using WebSocket 1.0</H1>
