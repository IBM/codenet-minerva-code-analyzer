   ...
   *************************************************/
    ...
    var messageServerHost = 'server';
    var messageServerPort = 'port'; 
	...
	function doRegister(userid) {
		...
		epConfig.server = messageServerHost;
		epConfig.port = parseInt(messageServerPort);
