...
<%@ taglib prefix="callSessionTag" uri="http://WebSessionClient2Lite/CallSessionTag.tld"%>
<TITLE>Client2 - Session Test Results page</TITLE>
...
<!--Banner-->
		<callSessionTag:session>
 				<jsp:attribute name="jspFragment1"> 
					<H1>Client2 - Session Test Results page</H1><BR>
					<H2>${message}</H2>
					<H3>===================================================================</H3>
