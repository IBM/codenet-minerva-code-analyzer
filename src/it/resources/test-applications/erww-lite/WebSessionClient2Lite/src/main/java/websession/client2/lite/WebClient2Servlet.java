...
/**
 * Servlet implementation class WebClient2Servlet
 */
@WebServlet("/WebClient2Servlet")
public class WebClient2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private String classname = "WebClient2Servlet";
	private IRWWBase irwwBase = new IRWWBase();
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WebClient2Servlet() {
        super();
    }
	...
	public void performTask(
			...
			irwwBase.debugOut("<<< Entering WebClien2Servlet");
			...
			irwwBase.debugOut("<<< WebClient2Servlet: current Item Id = " + currentItemIdString + " current Item Price = " + currentItemPriceString);
	...
	public HttpSession createHTTPSession(HttpServletRequest request,HttpServletResponse response, HttpSession aHttpSession)
		...
		public void processUrlPath(HttpServletRequest request, HttpServletResponse response, String currentItemId, 	String currentItemPrice, 
			...
			String reportTitle = "Web Client 2 - URL Rewriting Results";
			...
			printWriter.println("<h1>Client2 - URL Rewriting Results page</font></h1>");
			...
			printWriter.println("<A href=\"" + response.encodeURL("/WebSessionClient1Lite/WebClient1Servlet"	+ "?itemId=" + currentItemId)
		...
		public void dispatchNextPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try {
				...
				nextPage = "WebClient2ResultsForm.jsp";
