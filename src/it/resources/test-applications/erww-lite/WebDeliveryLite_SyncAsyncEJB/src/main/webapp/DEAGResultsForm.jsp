...
<%@ page 
contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" errorPage="error.jsp"
%>
<HTML>
<HEAD>
...
<%@ taglib prefix="callAutoGenTag" uri="http://WebDeliveryLite_SyncAsyncEJB/CallAutoGenTag.tld"%>
<%@ taglib prefix="outputDetailTag" uri="http://WebDeliveryLite_SyncAsyncEJB/DeliveryOutputDetailTag.tld"%>

<TITLE>Delivery Results - AutoGen Version</TITLE>
...
<callAutoGenTag:web object="${dEBean}"/>

<!--Banner-->
<H1>Delivery Results - AutoGen Version</H1>
