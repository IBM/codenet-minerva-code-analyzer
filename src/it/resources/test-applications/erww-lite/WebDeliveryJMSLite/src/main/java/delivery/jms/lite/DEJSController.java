...
/**
*Description - DE Front Controller
* 
...
public class DEJSController extends HttpServlet implements Serializable {
	
	
	/**
	 * Autogenerated UID
	 */
	private static final long serialVersionUID = -6548178429492958933L;
	static AtomicInteger DeliveryClientTxInFlightCounter = new AtomicInteger(0);
	...
	*/
	public void performTask(
		...
		try {
			...
			JMS_MDB_debugOut(">> JMSDeliveryClientTxInFlightCounter = " + DeliveryClientTxInFlightCounter.incrementAndGet());	  
		...
		JMS_MDB_debugOut("<< JMSDeliveryClientTxInFlightCounter = " + DeliveryClientTxInFlightCounter.decrementAndGet());	  
	}
